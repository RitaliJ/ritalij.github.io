      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-placeholder-ta-position-or-research-project-start-to-be-filled-in",
          title: 'Placeholder: TA position or research project start — to be filled in.',
          description: "",
          section: "News",},{id: "news-placeholder-conference-paper-submission-or-award-to-be-filled-in",
          title: 'Placeholder: conference, paper submission, or award — to be filled in.',
          description: "",
          section: "News",},{id: "news-placeholder-most-recent-update-to-be-filled-in",
          title: 'Placeholder: most recent update — to be filled in.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%6A%61%69%6E@%63%61%6C%74%65%63%68.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/RitaliJ", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ritali-jain-a70094258", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
